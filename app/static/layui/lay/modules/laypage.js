;layui.define(function(e){
    ...
    u.prototype.view=function(){
      ...
      // === English labels ===
      a.prev="prev"in a?a.prev:"Prev",
      a.next="next"in a?a.next:"Next";
      ...
      var n=a.pages>t?Math.ceil((a.curr+(t>1?1:0))/(t>0?t:1)):1,
          i={
            ...
            page:function(){
              var e=[];
              if(a.count<1)return"";
              n>1&&a.first!==!1&&0!==t&&e.push('<a href="javascript:;" class="layui-laypage-first" data-page="1" title="First">'+(a.first||1)+"</a>");
              ...
              return a.pages>t&&a.pages>u&&a.last!==!1&&(u+1<a.pages&&e.push('<span class="layui-laypage-spr">...</span>'),
                0!==t&&e.push('<a href="javascript:;" class="layui-laypage-last" title="Last" data-page="'+a.pages+'">'+(a.last||a.pages)+"</a>")),
              e.join("")
            }(),
            next:function(){
            ...
            limit:function(){
              ...
              return layui.each(a.limits,function(t,n){
                e.push('<option value="'+n+'"'+(n===a.limit?"selected":"")+">"+n+" per page</option>")
              }),
              e.join("")+"</select></span>"
            }(),
